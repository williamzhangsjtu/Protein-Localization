...
parser.add_argument('-c', '--config', default='config/pretrain.yaml', type=str)
...
def run(config_file):
    ...
    # )
    test_dataloader = pretrain_dataloader(
    ...
    for epoch in range(1, config['n_epoch'] + 1):
        ...
        logger.info("train_loss: {:.4f}\ttest_loss: {:.4f}".format(train_loss, test_loss))
